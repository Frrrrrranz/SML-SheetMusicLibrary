...
export const ComposersScreen: React.FC<ComposersScreenProps> = ({ composers, isLoading = false, onComposerSelect, onAddComposer, onUpdateComposer }) => {
  ...
  return (
    <div className="min-h-screen w-full bg-background pb-24 relative">
      ...
      {/* Header - 沉浸式设计，适配刘海屏 */}
      {/* Header - 沉浸式设计，适配刘海屏 */}
      <header className="sticky top-0 z-10 bg-background/90 backdrop-blur-xl backdrop-saturate-150 px-6 pt-[calc(env(safe-area-inset-top)+3.5rem)] pb-4 transition-all duration-300 border-b border-white/5">

...
export const AiChatScreen: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col pb-20">
            ...
            <header className="sticky top-0 z-30 bg-background/60 backdrop-blur-2xl backdrop-saturate-150 px-6 pt-[calc(env(safe-area-inset-top)+3.5rem)] pb-4 transition-all duration-300">

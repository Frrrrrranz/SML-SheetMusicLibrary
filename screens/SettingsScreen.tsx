...
import { BarChart2, Cloud, ChevronRight, Speaker, Palette, Share, LogOut } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background pb-24 font-sans">
      ...
      <div className="px-4 mb-8 mt-2">
        <div className="flex items-center gap-4 bg-white p-4 rounded-xl shadow-soft border border-gray-100">
          ...
          <div className="flex flex-col justify-center">
            <p className="text-xl font-bold leading-tight tracking-tight font-serif">My Library</p>
            <p className="text-textSub text-base font-medium mt-1">Standard Plan</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 mb-8">
        ...
        <div className="bg-white rounded-xl overflow-hidden shadow-soft border border-gray-100 divide-y divide-gray-100">
          ...
          <div className="flex items-center justify-center px-4 py-3.5 hover:bg-red-50 transition-colors cursor-pointer active:bg-red-100">
